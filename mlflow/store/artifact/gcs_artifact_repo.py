...
class GCSArtifactRepository(ArtifactRepository):
    ...
    def __init__(self, artifact_uri, client=None):
        ...
        self._GCS_DOWNLOAD_CHUNK_SIZE = int(os.environ.get("MLFLOW_GCS_DOWNLOAD_CHUNK_SIZE")) if os.environ.get("MLFLOW_GCS_DOWNLOAD_CHUNK_SIZE") else None
        self._GCS_UPLOAD_CHUNK_SIZE = int(os.environ.get("MLFLOW_GCS_UPLOAD_CHUNK_SIZE")) if os.environ.get("MLFLOW_GCS_UPLOAD_CHUNK_SIZE") else None
        self._GCS_DEFAULT_TIMEOUT = float(os.environ.get("MLFLOW_GCS_DEFAULT_TIMEOUT")) if os.environ.get("MLFLOW_GCS_DEFAULT_TIMEOUT") else _DEFAULT_TIMEOUT
    ...
    def log_artifacts(self, local_dir, artifact_path=None):
        ...
        for (root, _, filenames) in os.walk(local_dir):
            ...
            for f in filenames:
                ...
                gcs_bucket.blob(path, chunk_size=self._GCS_UPLOAD_CHUNK_SIZE).upload_from_filename(os.path.join(root, f),
